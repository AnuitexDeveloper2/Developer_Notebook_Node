...
import {
  ...
  addAppointment,
  editAppointment,
} from "./admin/contents.admin.handler";
import {
  getContentsByAppointmentId,
  searchContentByString,
} from "./user/contents.handler";
...
contentRouter.get("/user/:id", validate(get), getContentsByAppointmentId);

contentRouter.get("/search/:search", searchContentByString);
